...
export default class EquipmentFastFilters extends FastFilters {
    ...
    getFastFilters(context) {
        return [
            ...
            { name: FAST_FILTERS.MY_CHARACTERISTICS, value: this._getEquipChar(), visible: true},//Rohit
        ];
    }
    ...
    //Rohit
    _getEquipChar() {
        let query = "ClassCharValues/any(wp: (wp/Characteristic/CharDesc eq 'Pressure of the Equipment'))";
        return query;
    }
}
